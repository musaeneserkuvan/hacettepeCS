...
#ifndef UNTITLED19_LLRBT_H
#define UNTITLED19_LLRBT_H
...
public:
    ...
    void addNodeSecondary(const string& itemname,int price,secondaryN** ptr,secondaryN** root);
    //-------------------------------------------------------------------------------------
    ...
    void removeNode(const string& category,const string& itemname,secondaryN** ptr,secondaryN** root);
    ...
    static bool isRed(secondaryN** ptr);
